...
```bash
./tools/Search_Repo.py -q rag -o ./src/maual_update/RAG.md
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=langgenius/dify,open-webui/open-webui,lobehub/lobe-chat,infiniflow/ragflow,Shubhamsaboo/awesome-llm-apps,Mintplex-Labs/anything-llm,mendableai/firecrawl,run-llama/llama_index,FlowiseAI/Flowise,zhayujie/chatgpt-on-wechat&type=Date)](https://www.star-history.com/#langgenius/dify,open-webui/open-webui,lobehub/lobe-chat,infiniflow/ragflow,Shubhamsaboo/awesome-llm-apps,Mintplex-Labs/anything-llm,mendableai/firecrawl,run-llama/llama_index,FlowiseAI/Flowise,zhayujie/chatgpt-on-wechat&Date)
...
|45651|[mendableai/firecrawl](https://github.com/mendableai/firecrawl)|🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API.|TypeScript|2025-08-08|2024-04-15|
|43577|[run-llama/llama_index](https://github.com/run-llama/llama_index)|LlamaIndex is the leading framework for building LLM-powered agents over your data.|Python|2025-08-08|2022-11-02|
|42425|[FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise)|Build AI Agents, Visually|TypeScript|2025-08-08|2023-03-31|
...
|36452|[milvus-io/milvus](https://github.com/milvus-io/milvus)|Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search|Go|2025-08-08|2019-09-16|
|35820|[chatchat-space/Langchain-Chatchat](https://github.com/chatchat-space/Langchain-Chatchat)|Langchain-Chatchat（原Langchain-ChatGLM）基于 Langchain 与 ChatGLM, Qwen 与 Llama 等语言模型的 RAG 与 Agent 应用 &#124; Langchain-Chatchat (formerly langchain-ChatGLM), local knowledge based LLM (like ChatGLM, Qwen and Llama) RAG and Agent app with langchain |TypeScript|2025-08-08|2023-03-31|
...
|30404|[pathwaycom/pathway](https://github.com/pathwaycom/pathway)|Python ETL framework for stream processing, real-time analytics, LLM pipelines, and RAG.|Python|2025-08-08|2022-11-27|
|28880|[pathwaycom/llm-app](https://github.com/pathwaycom/llm-app)|Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs, and more.|Jupyter Notebook|2025-08-08|2023-07-19|
|27110|[microsoft/graphrag](https://github.com/microsoft/graphrag)|A modular graph-based Retrieval-Augmented Generation (RAG) system|Python|2025-08-08|2024-03-27|
